...
| Name                                                                                       | Aeneas (!P) | Creusot   | Flux (!P) | Kani | Verus   | VeriFast |
|--------------------------------------------------------------------------------------------|-------------|-----------|-----------|------|---------|----------|
| [ackermann](examples/ackermann.md)                                                         |             | ❌         |           |      | ❌       |          |
| [binary_search](examples/binary_search.md)                                                 |             |           |           |      | ✅, !P   |          |
| [concat_slices_to_vec](examples/concat_slices_to_vec.md)                                   |             | ✅, !T, !P |           |      | ✅, !P   |          |
| [concat_slices_to_vec_copy](examples/concat_slices_to_vec_copy.md)                         |             | ✅, !T, !P |           |      | ✅, !P   |          |
