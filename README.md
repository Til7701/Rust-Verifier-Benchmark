...
| Name                                                                                       | Aeneas (!P) | Creusot (!P) | Flux (!P) | Kani (!P) | Verus   | VeriFast (!P) |
|--------------------------------------------------------------------------------------------|-------------|--------------|-----------|-----------|---------|---------------|
| [ackermann](examples/ackermann.md)                                                         |             | ❌            |           |           | ❌       |               |
| [binary_search](examples/binary_search.md)                                                 |             |              |           |           | ✅, !P   |               |
| [concat_slices_to_vec](examples/concat_slices_to_vec.md)                                   |             | ✅, !T        |           |           | ✅, !P   |               |
| [concat_slices_to_vec_copy](examples/concat_slices_to_vec_copy.md)                         |             | ✅, !T        |           |           | ✅, !P   |               |
| [concat_slices_to_vec_std](examples/concat_slices_to_vec_std.md)                           |             | ❌            |           |           | (✅), !P |               |
